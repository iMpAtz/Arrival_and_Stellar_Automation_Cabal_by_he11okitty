# Auto Mail Receive tab UI
# Simple 2-position click automation
...
class MailTab:
    def __init__(self, parent_frame, main_window):
        """Initialize the Auto Mail Receive tab"""
    ...
    def create_ui(self):
        """Create the Auto Mail Receive UI"""
        ...
        title = tk.Label(text_frame, text="AUTO MAIL RECEIVE - Automated Mail Collection", 
                        font=('Segoe UI', 9, 'bold'), bg='#E3F2FD', fg=colors['text'], anchor='w')
        title.pack(fill=tk.X)
        
        subtitle = tk.Label(text_frame, text="Automatically clicks two positions to receive in-game mail", 
        ...
        tk.Label(coord_header, text="📍 Click Positions", 
        ...
        coord_row1.pack(fill=tk.X, pady=(0, 5))
    ...
    def _set_click_position(self, position_num, coord_var):
        ...
        messagebox.showinfo(
            "Instruction",
            f"Click on Position {position_num} in the game window.\n"
